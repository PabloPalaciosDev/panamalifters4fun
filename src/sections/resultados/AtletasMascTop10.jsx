...
export default function AtletasMascTop10() {
    ...
    let atletasMasculinosEncadenados = {};

    Object.entries(atletasMasculinos).forEach(([categoria, atletas]) => {
        atletasMasculinosEncadenados[categoria] = atletas.concat
        atletasMasculinosEncadenados[categoria] = atletas
            .sort((a, b) => a.top - b.top)
            .slice(0, 10);
    });

    console.log(atletasMasculinosEncadenados)
